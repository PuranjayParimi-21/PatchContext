...
st.sidebar.text(f"Model: {settings.openrouter_model if llm_provider == 'openrouter' else settings.model}")
...
if emb_provider in ["local", "huggingface"]:
    ...
    st.sidebar.warning("Using OpenAI/OpenRouter Embeddings")
